              ...
              <form action={createHoraAtividadeAction} className="mt-4 grid gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <a
                    ...
                    className="w-fit rounded-xl border border-zinc-200 bg-white px-4 py-2 text-sm font-semibold text-zinc-800 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-200 dark:hover:bg-zinc-900"
                  >
                    Listagem
                  </a>
                </div>
